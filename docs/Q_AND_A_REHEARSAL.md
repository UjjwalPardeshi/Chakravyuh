...
**DeepSeek-R1 with parser fix:** detection 100 % / FPR 12.9 % / F1 = 0.986 (was 0.7 % / 0 % / 0.014 before — parser artifact). Reasoning-aware fix at [`eval/frontier_baseline.py:_strip_reasoning`](../eval/frontier_baseline.py) plus `max_tokens=4096` for reasoning models. After the fix R1 is competitive with v2 LoRA on F1 (0.986 vs 0.990) but still FPR 12.9 % vs our 6.7 % (Fisher p = 0.67 — directional, not significant at this n).
