...
| **Frontier-LLMs-as-Scammer comparison** (do trained 0.5B Scammer beats untrained 670B at evading scripted defense?) | [`logs/scammer_frontier_comparison.csv`](../logs/scammer_frontier_comparison.csv) + [`logs/scammer_frontier_comparison.json`](../logs/scammer_frontier_comparison.json) + [`plots/chakravyuh_plots/scammer_frontier_bar.png`](../plots/chakravyuh_plots/scammer_frontier_bar.png) | ✅ shipped — Scammer LoRA best-of-8 (93.75 %) beats every untrained frontier including DeepSeek-V3 671B (31.2 %); single-shot (59.4 %) competitive with 70B-class |
| **DeepSeek-R1 reasoning-aware parser** (replaces previous parser artifact) | [`eval/frontier_baseline.py:_strip_reasoning`](../eval/frontier_baseline.py) + 5 unit tests | ✅ shipped — R1 now scores 100 % / 12.9 % / F1 = 0.986 (was 0.7 % / F1 = 0.014 — parser artifact) |
